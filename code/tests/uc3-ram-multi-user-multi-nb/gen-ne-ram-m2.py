...
nb1_m1 = {'id': 'nuvlabox/01',
          ...
          'DESCRIPTION': 'NE #1',
          'TAGS': [''],
          'RESOURCES': {'RAM': {'used': 9.1, 'capacity': 10, 'topic': 'ram'}},
          'RESOURCES_PREV': {
              'RAM': {'used': 8.5, 'capacity': 10, 'topic': 'ram'}},
          'RESOURCES_RAM_USED_PERS': 91.0,
          'RESOURCES_PREV_RAM_USED_PERS': 85.0,
          'TIMESTAMP': ts(),
          'ACL': {'owners': ['user/01'],
                  'view-data': ['user/02']}}
producer.send(TOPIC,
...
nb2_m1 = {'id': 'nuvlabox/02',
          ...
          'DESCRIPTION': 'NE #2',
          'TAGS': ['x86-64'],
          'RESOURCES': {'RAM': {'used': 9.2, 'capacity': 10, 'topic': 'ram'}},
          'RESOURCES_PREV': {
              'RAM': {'used': 8.6, 'capacity': 10, 'topic': 'ram'}},
          'RESOURCES_RAM_ram_PERS': 92.0,
          'RESOURCES_PREV_RAM_ram_PERS': 86.0,
          'TIMESTAMP': ts(),
          'ACL': {'owners': ['user/02'],
                  'view-data': ['user/01']}}
producer.send(TOPIC,
