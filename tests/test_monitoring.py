...
from nuvla.notifs.monitoring import search_if_present, act_on_deleted_entities


class TestMonitoring(unittest.TestCase):
    @patch('nuvla.notifs.monitoring.es_get_all_records')
    def test_search_if_present(self, mock_get_all_records):
        mock_get_all_records.side_effect = [['1111', '1111'], ['2222', '3333', '1111', '2222']]
        deleted_entities_ids = ['nuvlabox/1', 'subscription-config/1']
        ids_rxtx_to_be_deleted = search_if_present(None, deleted_entities_ids)
    ...
    def test_act_on_deleted_subscriptions(self, mock_search_if_present):
        ...
        act_on_deleted_entities(elastic_instance)
